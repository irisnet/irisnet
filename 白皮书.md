...
3. **分析员** 是代表IRIS 基金有限公司(“基金会”)的特珠用户，该基金会是一家香港注册股份有限公司。该基金会将率先建立IRIS网络。分析员是在分析模式中调用iServices的唯一授权用户，旨在帮助创建和维护客观的提供商概要，消费者可以通过这些文件来选择合适的供应商。
