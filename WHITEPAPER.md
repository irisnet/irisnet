...
* **Cosmos ATOM Holder Airdrop**: 5% (the goal for this airdrop is to support the long term successs of both Cosmos and IRIS hubs, the airdrop to ATOM holders could be arranged through a special airdrop to a wallet owned by the Cosmos Hub for ATOM holders and stake to IRISnet)
